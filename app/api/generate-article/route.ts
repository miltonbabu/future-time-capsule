...
export async function POST(req: Request) {
  ...
  const user = `Name: ${name}. Team: ${team}. Achievement they're known for: ${achievement}. The newspaper is dated ${futureDate} (year ${year}). Write their ${year} success story as a front-page newspaper article set in ${year}.`;
